...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script>const xw_xrpl_wss_server = "{{config('xrpl.'.config('xrpl.net').'.server_wss')}}";</script>
      ...
      <body class="@yield('class') antialiased bg-light">
        <main id="app">
          ...
          <div class="d-flex">
            ...
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-white border-start" style="width:280px">
              <span class="text-muted text-uppercase">Queue</span>
              <div>
                Queue is empty.
              </div>
            </div>
